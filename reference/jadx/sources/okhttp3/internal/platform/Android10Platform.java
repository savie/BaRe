...
public final class Android10Platform extends Platform implements ContextAwarePlatform {
    ...
    public Android10Platform() {
        List listP0 = x50.p0(new SocketAdapter[]{Build.VERSION.SDK_INT >= 29 ? new Android10SocketAdapter() : null, new DeferredSocketAdapter(AndroidSocketAdapter.e), new DeferredSocketAdapter(ConscryptSocketAdapter.a), new DeferredSocketAdapter(BouncyCastleSocketAdapter.a)});
