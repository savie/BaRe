...
public class qt2 extends vz7 {
    public final ny1 b;
    public s03 c;
    public final au1 d;
    public final nt2 e;

    public qt2(au1 au1Var, pt2 pt2Var, mt2 mt2Var, vq3 vq3Var) throws Exception {
        this.b = new ny1(au1Var, pt2Var, vq3Var);
        this.e = new nt2(au1Var, mt2Var, vq3Var);
        this.d = au1Var;
    }
    ...
    public final bw1 q(ai5 ai5Var) throws wt1 {
        ...
        au1 au1Var = this.d;
        if (au1Var != null) {
            return new ep1(ai5Var, this.b, s03VarF, au1Var);
        }
