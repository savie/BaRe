...
public final class qt7 {
    ...
    public qt7(float f, float f2, float f3, float f4) {
        this.a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    public final boolean equals(Object obj) {
        ...
        qt7 qt7Var = (qt7) obj;
        return Float.compare(this.a, qt7Var.a) == 0 && Float.compare(this.b, qt7Var.b) == 0 && Float.compare(this.c, qt7Var.c) == 0 && Float.compare(this.d, qt7Var.d) == 0;
    }
