...
public final class yq6 extends ArrayAdapter {
    public final LayoutInflater a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public yq6(Context context, List list) {
    ...
    public final View a(int i, View view, ViewGroup viewGroup) {
        ...
        xq6 xq6Var = (xq6) getItem(i);
        if (xq6Var == null) {
            xq6Var = xq6.j;
        }
        View viewFindViewById = view.findViewById(R.id.divider);
        viewFindViewById.getClass();
        sz8.d0(viewFindViewById, pe4.d(el1.V0(i, xq6.m), el1.U0(xq6.l)));
