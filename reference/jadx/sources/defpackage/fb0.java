...
public final class fb0 implements fr5 {
    ...
    static {
        ...
        b = new h63(Collections.unmodifiableMap(new HashMap(map)), "startMs");
        f70 f70Var2 = new f70(2);
        HashMap map2 = new HashMap();
        map2.put(r96.class, f70Var2);
        c = new h63(Collections.unmodifiableMap(new HashMap(map2)), "endMs");
    }
