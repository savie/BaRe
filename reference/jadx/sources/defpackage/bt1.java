...
public abstract class bt1 extends View {
    public int[] a;
    public int b;
    ...
    public final void a(String str) {
        ...
        int identifier;
        HashMap map;
        if (str.length() == 0 || (context = this.c) == null) {
            return;
        }
        ...
        if (!isInEditMode() || constraintLayout == null) {
            ...
            Object obj = (strTrim == null || (map = constraintLayout.x) == null || !map.containsKey(strTrim)) ? null : constraintLayout.x.get(strTrim);
        ...
        if (identifier == 0) {
            try {
                identifier = pd6.class.getField(strTrim).getInt(null);
        ...
        if (identifier != 0) {
            this.k.put(Integer.valueOf(identifier), strTrim);
            b(identifier);
        } else {
    ...
    public final void c(String str) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((layoutParams instanceof dt1) && strTrim.equals(((dt1) layoutParams).Y)) {
                if (childAt.getId() == -1) {
    ...
    public bt1(Context context, AttributeSet attributeSet, int i) {
    ...
    public void i(ot1 ot1Var, boolean z) {
    }
}
