...
public class ad5 extends ao implements Menu {
    public final fc5 c;

    public ad5(Context context, fc5 fc5Var) {
        super(context);
        if (fc5Var != null) {
            this.c = fc5Var;
        } else {
    ...
    public final int addIntentOptions(int i, int i2, int i3, ComponentName componentName, Intent[] intentArr, Intent intent, int i4, MenuItem[] menuItemArr) {
        ...
        if (menuItemArr2 != null) {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                menuItemArr[i5] = i(menuItemArr2[i5]);
            }
        }
    ...
    public final void removeGroup(int i) {
        if (((dg7) this.b) != null) {
            ...
            while (true) {
                ...
                if (((ls7) dg7Var.g(i2)).getGroupId() == i) {
                    ((dg7) this.b).i(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (((dg7) this.b) != null) {
            ...
            while (true) {
                ...
                if (((ls7) dg7Var.g(i2)).getItemId() == i) {
                    ((dg7) this.b).i(i2);
                    break;
                }
                i2++;
