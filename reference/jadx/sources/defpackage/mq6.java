...
public final class mq6 extends Drawable {
    public float a;
    ...
    public mq6(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(nq6.a(this.e, this.a, this.g)), (int) Math.ceil(nq6.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
