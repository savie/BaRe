...
public final class em9 extends og9 implements RandomAccess {
    ...
    static {
        ...
        d = objArr;
        e = new em9(objArr, 0, false);
    }

    public em9(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.c = i;
    }
    ...
    public final /* bridge */ /* synthetic */ ej9 zzd(int i) {
        if (i >= this.c) {
            return new em9(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
        c6.b();
        return null;
    }
