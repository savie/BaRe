...
public final class g37 extends j9 {
    @Override // defpackage.j9
    public final Intent createIntent(Context context, Object obj) {
        Bundle bundle = (Bundle) obj;
        Intent intent = new Intent(context, (Class<?>) ScheduleFolderSelectActivity.class);
        if (bundle == null) {
    ...
    public final Object parseResult(Intent intent, int i) {
        ...
        return (h37) intent.getParcelableExtra("EXTRA_RESULT", h37.class);
    }
}
