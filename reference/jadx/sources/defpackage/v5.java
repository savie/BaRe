...
public final class v5 extends View.AccessibilityDelegate {
    ...
    public final AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
        zq8 zq8VarB = this.a.b(view);
        if (zq8VarB != null) {
            return (AccessibilityNodeProvider) zq8VarB.b;
        }
        return null;
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            tag = Boolean.valueOf(yk8.c(view));
        } else {
        ...
        m6Var.n(bool != null && bool.booleanValue());
        if (Build.VERSION.SDK_INT >= 28) {
            tag2 = Boolean.valueOf(yk8.b(view));
        } else {
        ...
        m6Var.l(bool2 != null && bool2.booleanValue());
        m6Var.m(dl8.e(view));
