...
public abstract class th6 {
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbU = dj7.u("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbU.append(e(e));
            throw new ik4(sbU.toString(), e);
        }
    }
}
