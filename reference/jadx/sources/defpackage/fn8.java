...
public final class fn8 {
    ...
    static {
        float[] fArr = jd4.e;
        float fN = (float) ((((double) jd4.N()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = jd4.c;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float f9 = 1.0f / ((5.0f * fN) + 1.0f);
        float f10 = f9 * f9 * f9 * f9;
        float f11 = 1.0f - f10;
        float fCbrt = (0.1f * f11 * f11 * ((float) Math.cbrt(((double) fN) * 5.0d))) + (f10 * fN);
        float fN2 = jd4.N() / fArr[1];
        double d2 = fN2;
        ...
        k = new fn8(fN2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, 0.69f, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public fn8(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
