...
public final class f55 implements g55 {
    ...
    public final Set a() {
        ...
        boolean z = g42.a;
        List<String> listH = mp6.a.h(new String[]{g42.i("ls", "", "")}, ip6.SU);
    ...
    public final void b(String str) {
        ...
        if (mp6.g && mp6.e() && !str.equals("com.google.android.gms")) {
            ...
            for (String str2 : collectionT) {
                boolean z = g42.a;
                arrayList.add(g42.i("add", str, str2));
            }
            mp6 mp6Var2 = mp6.a;
    ...
    public final void e() {
        ...
        if (mp6.g && mp6.e()) {
            boolean z = g42.a;
            mp6.a.h(new String[]{g42.i("enable", "", "")}, ip6.SU);
        }
    }

    public final boolean equals(Object obj) {
        return this == obj || (obj instanceof f55);
    }
    ...
    public final boolean isEnabled() {
        ...
        if (mp6.g && mp6.e()) {
            ...
            boolean z = g42.a;
            if (shellHelper.su(g42.i("status", "", "")).b().c == 0) {
                return true;
            }
        }
        return false;
