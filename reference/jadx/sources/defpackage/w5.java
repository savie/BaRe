...
public class w5 {
    ...
    public w5(View.AccessibilityDelegate accessibilityDelegate) {
    ...
    public zq8 b(View view) {
        AccessibilityNodeProvider accessibilityNodeProvider = this.a.getAccessibilityNodeProvider(view);
        if (accessibilityNodeProvider != null) {
            return new zq8(accessibilityNodeProvider, 1);
        }
        return null;
    }
            ...
            if (i2 < list.size()) {
                ...
                if (g6Var.a() == i) {
                    ...
                    if (w6Var != null) {
                        ...
                        zPerformAccessibilityAction = w6Var.d(view);
                        break;
                    }
                } else {
                    i2++;
