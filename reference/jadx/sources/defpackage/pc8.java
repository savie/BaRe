...
public final class pc8 extends mc8 implements Serializable {
    public final s65 c;
    public final ConcurrentHashMap d;
    public final HashMap e;

    public pc8(v77 v77Var, gc8 gc8Var, ConcurrentHashMap concurrentHashMap, HashMap map) {
    ...
    public final String toString() {
        return String.format("[%s; id-to-type=%s]", pc8.class.getName(), this.e);
    }
}
