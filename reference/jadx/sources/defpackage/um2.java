...
public final class um2 implements oy5 {
    ...
    public um2(wm2 wm2Var, fi7 fi7Var, Set set, Set set2, Set set3, int i, Set set4) {
        this.k = wm2Var;
        this.a = fi7Var;
        this.b = set;
        this.c = set2;
    ...
    public final Object b(fi7 fi7Var) {
        ...
        return wm2.g(wm2Var, fi7Var, this.b, this.c, this.d, this.e, this.f);
    }
}
