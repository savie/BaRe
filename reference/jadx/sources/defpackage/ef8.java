...
public abstract class ef8 {
    ...
    static {
        ...
        if (unsafeI != null) {
            if (!fb.a()) {
                cf8Var = new cf8(unsafeI);
            } else if (zH) {
                cf8Var = new bf8(unsafeI);
            } else if (zH2) {
                cf8Var = new af8(unsafeI);
            }
        }
        c = cf8Var;
        d = cf8Var == null ? false : cf8Var.r();
        e = cf8Var == null ? false : cf8Var.q();
        f = e(byte[].class);
        e(boolean[].class);
        f(boolean[].class);
        e(int[].class);
    ...
    public static void a(Throwable th) {
        Logger.getLogger(ef8.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th);
    }
    ...
    public static Unsafe i() {
        try {
            return (Unsafe) AccessController.doPrivileged(new ze8());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static void l(Object obj, long j, byte b2) {
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        m(obj, j2, ((255 & b2) << i) | (c.f(obj, j2) & (~(255 << i))));
    }
