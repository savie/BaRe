...
public abstract class y49 {
    ...
    /* JADX WARN: Code duplicated, block: B:83:0x011f A[FALL_THROUGH] */
    public static kg3 a(Status status) {
        int i = status.a;
        Pair pair = (Pair) a.get(i);
        String strC = c(pair != null ? (String) pair.second : "An internal error has occurred.", status);
        if (i == 17020) {
            return new sg3(c("A network error (such as timeout, interrupted connection or unreachable host) has occurred.", status));
        }
        if (i != 17021) {
            if (i != 17051) {
                if (i == 17052) {
                        ...
                        if (i != 17049) {
                            if (i != 17068) {
                                if (i != 17077) {
                                    if (i != 17214) {
                                        if (i == 17495) {
                                            return new tg3(c("Please sign in before trying to get a token.", status));
                                        }
                                        if (i == 17499) {
                                            return new kg3(c("An internal error has occurred.", status));
                                        }
                                        if (i != 17209 && i != 17210 && i != 18001 && i != 18002) {
                                            switch (i) {
                                                case 17004:
                                                case 17008:
                                                case 17009:
                                                ...
                                                case 17007:
                                                case 17012:
                                                    return new rf3(b(i), strC);
                                                case 17010:
                                                    return new fh3(c("We have blocked all requests from this device due to unusual activity. Try again later.", status));
                                                default:
                                                    switch (i) {
                                                        case 17079:
                                                        case 17085:
                                                        ...
                                                        default:
                                                            switch (i) {
                                                                ...
                                                                default:
                                                                    switch (i) {
                                                                        case 17200:
                                                                            return new pf3(b(i), strC);
                                                                        default:
                                                                            switch (i) {
                                                                                case 17014:
                                                                                    return new qf3(b(i), strC);
                                                                                case 17015:
                                                                                    return new kg3(c("User has already been linked to the given provider.", status));
                                                                                case 17016:
                                                                                    return new kg3(c("User was not linked to an account with the given provider.", status));
                                                                                case 17017:
                                                                                    break;
                                                                                default:
                                                                                    switch (i) {
                                                                                        ...
                                                                                        default:
                                                                                            switch (i) {
                                                                                                ...
                                                                                                case 17029:
                                                                                                case 17030:
                                                                                                    return new kf3(b(i), strC);
                                                                                                case 17031:
                                                                                                case 17032:
                                                                                                case 17033:
                                                                                                    return new lf3(b(i), strC);
                                                                                                case 17034:
                                                                                                case 17035:
                                                                                                    break;
                                                                                                default:
                                                                                                    switch (i) {
                                                                                                        ...
                                                                                                        default:
                                                                                                            switch (i) {
                                                                                                                case 17056:
                                                                                                                    return new nf3(b(i), strC);
                                                                                                                default:
                                                                                                                    switch (i) {
                                                                                                                        case 17061:
                                                                                                                            return new sg3(c("There was a failure in the connection between the web widget and the Firebase Auth backend.", status));
                                                                                                                        case 17062:
                                                                                                                        case 17065:
                                                                                                                            break;
                                                                                                                        case 17063:
                                                                                                                        ...
                                                                                                                        default:
                                                                                                                            switch (i) {
                                                                                                                                ...
                                                                                                                                case 17075:
                                                                                                                                    break;
                                                                                                                                default:
                                                                                                                                    return new kg3("An internal error has occurred.");
                                                                                                                            }
                                                                                                                        case 17064:
                                                                                                                            return new mf3(b(i), strC);
                                                                                                                    }
                                                                                                                case 17057:
                                                                                                                case 17058:
                                                                                                                    return new tf3(b(i), strC);
                                                                                                            }
                                                                                                            break;
                                                                                                    }
                                                                                                    break;
    ...
    public static String c(String str, Status status) {
        return TextUtils.isEmpty(status.b) ? str : u48.n(str, " [ ", status.b, " ]");
    }
}
