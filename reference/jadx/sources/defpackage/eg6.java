...
public final class eg6 extends FilterInputStream {
    ...
    public eg6(InputStream inputStream, m35 m35Var) {
        super(inputStream);
        this.d = -1;
        this.f = m35Var;
        this.a = (byte[]) m35Var.c(65536, byte[].class);
    }
    ...
    public final synchronized void reset() {
        ...
        int i = this.d;
        if (-1 == i) {
            throw new tj4("Mark has been invalidated, pos: " + this.e + " markLimit: " + this.c);
        }
        this.e = i;
    }
