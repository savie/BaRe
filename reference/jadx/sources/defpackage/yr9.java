...
public abstract class yr9 {
    ...
    public static BigInteger a(EllipticCurve ellipticCurve) {
        ...
        m0.h("Only curves over prime order fields are supported");
        return null;
    }
    ...
    public static ECPoint c(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        if (!h(eCParameterSpec, a) && !h(eCParameterSpec, b) && !h(eCParameterSpec, c)) {
            m0.h("spec must be NIST P256, P384 or P521");
            return null;
        }
        if (bigInteger.signum() != 1) {
            m0.h("k must be positive");
            return null;
        }
        if (bigInteger.compareTo(eCParameterSpec.getOrder()) >= 0) {
            m0.h("k must be smaller than the order of the generator");
            return null;
        }
        ...
        zr9 zr9VarD = d(ECPoint.POINT_INFINITY, bigIntegerA);
        zr9 zr9VarD2 = d(generator, bigIntegerA);
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zr9VarD = f(zr9VarD, zr9VarD2, a2, bigIntegerA);
                zr9VarD2 = e(zr9VarD2, a2, bigIntegerA);
            } else {
                zr9VarD2 = f(zr9VarD, zr9VarD2, a2, bigIntegerA);
                zr9VarD = e(zr9VarD, a2, bigIntegerA);
            }
        }
        if (zr9VarD.c.equals(BigInteger.ZERO)) {
            eCPoint = ECPoint.POINT_INFINITY;
        } else {
            BigInteger bigIntegerModInverse = zr9VarD.c.modInverse(bigIntegerA);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerA);
            eCPoint = new ECPoint(zr9VarD.a.multiply(bigIntegerMod).mod(bigIntegerA), zr9VarD.b.multiply(bigIntegerMod).mod(bigIntegerA).multiply(bigIntegerModInverse).mod(bigIntegerA));
        }
        g(eCPoint, curve);
        return eCPoint;
    }

    public static zr9 d(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return zr9.d;
        }
        BigInteger bigIntegerMod = new BigInteger(1, rt9.a((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new zr9(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }

    public static zr9 e(zr9 zr9Var, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = zr9Var.b;
        BigInteger bigInteger4 = zr9Var.c;
        BigInteger bigInteger5 = zr9Var.b;
        BigInteger bigInteger6 = zr9Var.a;
        ...
        return new zr9(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }

    public static zr9 f(zr9 zr9Var, zr9 zr9Var2, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = zr9Var.c;
        BigInteger bigInteger4 = BigInteger.ZERO;
        boolean zEquals = bigInteger3.equals(bigInteger4);
        BigInteger bigInteger5 = zr9Var.c;
        if (zEquals) {
            return zr9Var2;
        }
        boolean zEquals2 = zr9Var2.c.equals(bigInteger4);
        BigInteger bigInteger6 = zr9Var2.c;
        if (zEquals2) {
            return zr9Var;
        }
        ...
        BigInteger bigIntegerMod3 = zr9Var.a.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zr9Var2.a.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = zr9Var.b.multiply(bigInteger6).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = zr9Var2.b.multiply(bigInteger5).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? zr9.d : e(zr9Var, bigInteger, bigInteger2);
        }
        ...
        return new zr9(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
