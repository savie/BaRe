    ...
    public final void init(Session session, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) throws Exception {
        ...
        try {
            ...
            try {
                ...
                System.arraycopy(q, 0, this.k, this.v, this.y);
        ...
        if (this.j == 31) {
            ...
            if (i == 31) {
                ...
                if (length == i2 + i3) {
                    ...
                    System.arraycopy(string, this.w, bArr2, 0, this.y);
                    byte[][] bArrY = KeyPairECDSA.y(bArr2);
                    if (this.s.validate(bArrY[0], bArrY[1])) {
                        ...
                        try {
                            ...
                            try {
                                bArrDecapsulate = this.s.getSecret(bArrY[0], bArrY[1]);
                                this.b.update(bArrDecapsulate, 0, bArrDecapsulate.length);
                                Util.e(bArrDecapsulate);
                ...
                this.a.getLogger().log(3, "type: must be SSH_MSG_KEX_HYBRID_REPLY " + i);
                return false;
            }
        }
        return false;
