...
public final class Tasks {
    ...
    public static <TResult> TResult await(Task<TResult> task, long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ly8.g("Must not be called on the main application thread");
        Looper looperMyLooper = Looper.myLooper();
        if (looperMyLooper != null && Objects.equals(looperMyLooper.getThread().getName(), "GoogleApiHandler")) {
            l0.e("Must not be called on GoogleApiHandler thread.");
            return null;
        }
        ly8.i(task, "Task must not be null");
        ly8.i(timeUnit, "TimeUnit must not be null");
        if (task.isComplete()) {
    ...
    public static <TResult> Task<TResult> call(Executor executor, Callable<TResult> callable) {
        ly8.i(executor, "Executor must not be null");
        ly8.i(callable, "Callback must not be null");
        zzw zzwVar = new zzw();
    ...
    public static Task<Void> whenAll(Collection<? extends Task<?>> collection) {
        ...
        while (it.hasNext()) {
            if (it.next() == null) {
                f6.n("null tasks are not accepted");
                return null;
            }
        }
        zzw zzwVar = new zzw();
    ...
    public static <T> Task<T> withTimeout(Task<T> task, long j, TimeUnit timeUnit) {
        ly8.i(task, "Task must not be null");
        ly8.b("Timeout must be positive", j > 0);
        ly8.i(timeUnit, "TimeUnit must not be null");
        ...
        q39Var.postDelayed(new Runnable() { // from class: com.google.android.gms.tasks.zzad
        ...
        task.addOnCompleteListener(new OnCompleteListener() { // from class: com.google.android.gms.tasks.zzac
            ...
            public final /* synthetic */ void onComplete(Task task2) {
                q39Var.removeCallbacksAndMessages(null);
