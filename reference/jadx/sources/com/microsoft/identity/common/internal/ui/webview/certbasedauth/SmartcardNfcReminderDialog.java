...
public final class SmartcardNfcReminderDialog extends SmartcardDialog {
    private final IDismissCallback mDismissCallback;

    public SmartcardNfcReminderDialog(IDismissCallback iDismissCallback, u uVar) {
        super(uVar);
        this.mDismissCallback = iDismissCallback;
        uVar.runOnUiThread(new SmartcardDialog.AnonymousClass1(this, 1));
    }
