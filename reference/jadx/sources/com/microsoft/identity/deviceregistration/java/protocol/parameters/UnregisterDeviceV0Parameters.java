...
public class UnregisterDeviceV0Parameters extends AbstractDeviceRegistrationProtocolParameters {
    ...
    public UnregisterDeviceV0Parameters(UUID uuid, IDeviceRegistrationRecord iDeviceRegistrationRecord) {
        super(uuid);
        if (uuid == null) {
    ...
    public static UnregisterDeviceV0Parameters create(byte[] bArr) throws ClientException {
        return (UnregisterDeviceV0Parameters) ((DeviceRegistrationProtocolMoshiSerializer) serializer).deserialize(bArr);
    }
