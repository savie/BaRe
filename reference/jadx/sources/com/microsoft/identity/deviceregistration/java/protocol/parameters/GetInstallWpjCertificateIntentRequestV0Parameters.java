...
public class GetInstallWpjCertificateIntentRequestV0Parameters extends AbstractDeviceRegistrationProtocolParameters {
    private static final IDeviceRegistrationProtocolSerializer<GetInstallWpjCertificateIntentRequestV0Parameters> serializer = new DeviceRegistrationProtocolMoshiSerializer(GetInstallWpjCertificateIntentRequestV0Parameters.class);
    private final IDeviceRegistrationRecord mDeviceRegistrationRecord;

    public GetInstallWpjCertificateIntentRequestV0Parameters(UUID uuid, IDeviceRegistrationRecord iDeviceRegistrationRecord) {
        super(uuid);
        if (uuid == null) {
    ...
    public static GetInstallWpjCertificateIntentRequestV0Parameters create(byte[] bArr) throws ClientException {
        return (GetInstallWpjCertificateIntentRequestV0Parameters) ((DeviceRegistrationProtocolMoshiSerializer) serializer).deserialize(bArr);
    }
    ...
    public String getProtocolName() {
        return "protocol.install.certificate.v0";
    }
