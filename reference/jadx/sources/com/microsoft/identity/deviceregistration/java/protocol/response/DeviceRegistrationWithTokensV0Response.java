...
public class DeviceRegistrationWithTokensV0Response extends AbstractDeviceRegistrationProtocolResponse {
    private static final IDeviceRegistrationProtocolSerializer<DeviceRegistrationWithTokensV0Response> serializer = new DeviceRegistrationProtocolMoshiSerializer(DeviceRegistrationWithTokensV0Response.class);
    private final IDeviceRegistrationRecord mDeviceRegistrationRecord;

    public DeviceRegistrationWithTokensV0Response(UUID uuid, IDeviceRegistrationRecord iDeviceRegistrationRecord) {
        super(uuid);
        if (uuid == null) {
    ...
    public static DeviceRegistrationWithTokensV0Response create(byte[] bArr) throws ClientException {
        return (DeviceRegistrationWithTokensV0Response) ((DeviceRegistrationProtocolMoshiSerializer) serializer).deserialize(bArr);
    }
