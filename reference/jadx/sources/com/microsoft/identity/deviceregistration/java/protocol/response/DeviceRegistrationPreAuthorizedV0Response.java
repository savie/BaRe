...
public class DeviceRegistrationPreAuthorizedV0Response extends AbstractDeviceRegistrationProtocolResponse {
    ...
    public DeviceRegistrationPreAuthorizedV0Response(UUID uuid, IDeviceRegistrationRecord iDeviceRegistrationRecord) {
        super(uuid);
        if (uuid == null) {
    ...
    public static DeviceRegistrationPreAuthorizedV0Response create(byte[] bArr) throws ClientException {
        return (DeviceRegistrationPreAuthorizedV0Response) ((DeviceRegistrationProtocolMoshiSerializer) serializer).deserialize(bArr);
    }
