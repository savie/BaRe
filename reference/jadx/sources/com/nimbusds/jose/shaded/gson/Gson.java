...
public final class Gson {
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z) {
        return z ? TypeAdapters.DOUBLE : new TypeAdapter<Number>() { // from class: com.nimbusds.jose.shaded.gson.Gson.1
            @Override // com.nimbusds.jose.shaded.gson.TypeAdapter
    ...
    private TypeAdapter<Number> floatAdapter(boolean z) {
        return z ? TypeAdapters.FLOAT : new TypeAdapter<Number>() { // from class: com.nimbusds.jose.shaded.gson.Gson.2
            @Override // com.nimbusds.jose.shaded.gson.TypeAdapter
            /* JADX INFO: renamed from: read */
            public Number read2(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() != JsonToken.NULL) {
    ...
    private static TypeAdapter<Number> longAdapter(LongSerializationPolicy longSerializationPolicy) {
        return longSerializationPolicy == LongSerializationPolicy.DEFAULT ? TypeAdapters.LONG : new TypeAdapter<Number>() { // from class: com.nimbusds.jose.shaded.gson.Gson.3
    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> typeToken) {
        ...
        try {
            ...
            if (typeAdapterCreate == null) {
                g84.k(typeToken, "GSON (2.12.1) cannot handle ");
                return null;
            }
            if (z) {
