...
public class JsonReader implements Closeable {
    ...
    private boolean isLiteral(char c) throws IOException {
        if (c == '\t' || c == '\n' || c == PEEKED_SINGLE_QUOTED_NAME || c == PEEKED_DOUBLE_QUOTED_NAME || c == ' ') {
            return false;
        }
        if (c != '#') {
            if (c == ',') {
    ...
    private int nextNonWhitespace(boolean z) throws IOException {
        ...
        while (true) {
            ...
            if (c == '\n') {
                this.lineNumber++;
                this.lineStart = i3;
            } else if (c != ' ' && c != PEEKED_DOUBLE_QUOTED_NAME && c != '\t') {
                if (c == '/') {
                    this.pos = i3;
                    if (i3 == i2) {
                        this.pos = i;
    ...
    private MalformedJsonException syntaxError(String str) throws MalformedJsonException {
        ...
        sbS.append("\nSee ");
        sbS.append(TroubleshootingGuide.createUrl("malformed-json"));
    ...
    public IllegalStateException unexpectedTokenError(String str) throws IOException {
        ...
        sbU.append("\nSee ");
        sbU.append(TroubleshootingGuide.createUrl(str2));
    ...
    public int nextInt() throws IOException {
        ...
        int i5 = (int) d;
        if (i5 != d) {
            y5.f(this.peekedString, locationString(), "Expected an int but was ");
            return 0;
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    public long nextLong() throws IOException {
        ...
        long j2 = (long) d;
        if (j2 != d) {
            y5.f(this.peekedString, locationString(), "Expected a long but was ");
            return 0L;
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    public final void setNestingLimit(int i) {
        if (i >= 0) {
            ...
            c6.f(fz5.j(i, "Invalid nesting limit: "));
        }
    }
