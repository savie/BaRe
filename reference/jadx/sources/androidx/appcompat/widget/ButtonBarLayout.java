...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        dl8.m(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, 0);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.b || View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size, SftpATTRS.SSH_FILEXFER_ATTR_EXTENDED);
            z = true;
        }
