...
public class FileProvider extends ContentProvider {
    ...
    public static String a(String str) {
        return (str.length() <= 0 || str.charAt(str.length() - 1) != '/') ? str : xs1.g(1, 0, str);
    }

    public static e93 c(int i, Context context, String str) {
        e93 e93VarD;
        HashMap map = k;
        synchronized (map) {
            try {
                e93VarD = (e93) map.get(str);
                if (e93VarD == null) {
                    try {
                        try {
                            e93VarD = d(i, context, str);
                            map.put(str, e93VarD);
    ...
    public static e93 d(int i, Context context, String str) {
        File externalStorageDirectory;
        e93 e93Var = new e93(str);
        ProviderInfo providerInfoResolveContentProvider = context.getPackageManager().resolveContentProvider(str, 128);
        if (providerInfoResolveContentProvider == null) {
            c6.f(xs1.j("Couldn't find meta-data for provider with authority ", str));
            return null;
        }
        ...
        if (xmlResourceParserLoadXmlMetaData == null) {
            c6.f("Missing android.support.FILE_PROVIDER_PATHS meta-data");
            return null;
        }
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory == null) {
                    ...
                    try {
                        e93Var.b.put(attributeValue, externalStorageDirectory.getCanonicalFile());
                    } catch (IOException e2) {
