...
fun MiscScreen(screen: Screen, onBack: () -> Unit) {
    when (screen) {
        ...
        Screen.MESSAGES -> GenericDomainScreen(stringResource(R.string.messages), stringResource(R.string.messages_summary), listOf(stringResource(R.string.sms_mms_rcs), stringResource(R.string.attachments), "RCS", stringResource(R.string.backup), stringResource(R.string.restore), stringResource(R.string.history)), onBack)
        ...
        Screen.SETTINGS -> GenericDomainScreen(stringResource(R.string.settings), stringResource(R.string.settings_summary), listOf("Appearance", stringResource(R.string.language), stringResource(R.string.backup_defaults), stringResource(R.string.restore_defaults), "Security", stringResource(R.string.compression), stringResource(R.string.notifications), stringResource(R.string.about)), onBack)
